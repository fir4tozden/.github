...
[![Skills](https://skillicons.dev/icons?i=ts,js,bun,nodejs,npm,elysia,express,prisma,mongodb,redis,rabbitmq,aws,cloudflare,firebase,docker,nextjs,react,tailwind,htmx,regex,github,githubactions,git,linux,ubuntu,bash,md)](https://skillicons.dev)
