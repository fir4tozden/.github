...
[![Skills](https://skillicons.dev/icons?i=ts,js,bun,nodejs,npm,elysia,express,prisma,mongodb,redis,rabbitmq,aws,cloudflare,firebase,docker,nextjs,react,tailwind,github,githubactions,git,linux)](https://skillicons.dev)
